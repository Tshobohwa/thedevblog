...
# 📖 thedevblog <a name="about-project"></a>

thedevblog is a blog website where users have the ability to create blogs related to web development, like them, and also comment on them. It has been implemented using the Ruby on Rails library and PostgreSQL.
...
```sh
  cd my-folder
  git clone https://github.com/Tshobohwa/thedevblog.git
```
...
Feel free to check the [issues page](https://github.com/Tshobohwa/thedevblog/issues/).
